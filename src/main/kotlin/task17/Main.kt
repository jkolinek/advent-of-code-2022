...
fun main() {
    ...
    fun selectRock(it: Int): Rock {
        when (it % 5) {
            0 -> return  Rock1(3, chamber.maxY() + 4)
            1 -> return  Rock2(3, chamber.maxY() + 4)
            2 -> return  Rock3(3, chamber.maxY() + 4)
            3 -> return  Rock4(3, chamber.maxY() + 4)
            4 -> return  Rock5(3, chamber.maxY() + 4)
        }
